...
- [Instalación en Ubuntu](../INSTALL.md): servidor limpio, usuario `deploy`, Python, systemd y túnel.
- [Cloudflare Tunnel](cloudflare-tunnel.md): dominio, servicio, token y diagnóstico.
...
La guía local se ejecuta en tu Mac; `INSTALL.md` describe el despliegue completo
